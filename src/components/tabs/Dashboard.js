      ...
      <Masonry columns={2} spacing={2}>
            ...
            <CardContent>
                <div className='dashboard-profilecard'>
                    <div className='dashboard-profilecard-overview'>
                        <Avatar src='https://images1-fabric.practo.com/doctor/783127/dr-patki-swapna-kishore-6231cac516908.JPG'  sx={{
                            width:'100px',
                            height:'100px',
                            justifySelf:'center'
                        }} />
        ...
        <Card>
            <CardContent>
                ...
                <p className="dashboard-notescard-bottomTitle">Lorium Ipsium dolor sit</p>
                <div className="dashboard-notescard-bottom">
                    <Person />
                    <p className="dashboard-notescard-bottom-name">Drg. Mega Nanade</p>
                    <p>27 Nov, 2021</p>
                </div>
            </CardContent>
        </Card>
        ...
        <Card >
            <CardContent>
                <TabsUnstyled  value={selectedAptTab} onChange={(ev, selectedTab) => setAptTab(selectedTab)}>
                    <TabsList style={{backgroundColor:"#efefef",fontSize:'12px',padding:'0px',margin:'0px'}}>
