    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={openDrawer}>
        <DrawerHeader>
          ...
          <Typography varient="caption" display="block" gutterBottom>Cabut gigi</Typography>
          </div>
          ...
          <ListItemButton
            ...
            <Accordion expanded={openDoctorInfo} onChange={(ev, expanded) => setOpenDoctorInfo(expanded)}>
                <AccordionSummary
                  ...
                  id="panel1a-header"
                >
                  <Avatar  alt="Remy Sharp" src='https://images1-fabric.practo.com/doctor/783127/dr-patki-swapna-kishore-6231cac516908.JPG' />
                  {
                    openDrawer && 
                    <React.Fragment>
                      &nbsp;&nbsp;
